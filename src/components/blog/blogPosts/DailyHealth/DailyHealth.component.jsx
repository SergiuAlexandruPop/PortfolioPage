...
<br/>
          ...
          <div>
              <p>If you want to live the best life you can, I'll live here all the resources you need:</p>
              <ul>
                <ListContainer><ResourceTitle to={{pathname: "https://www.youtube.com/@hubermanlab" }}>Dr. Andrew Huberman's Youtube Chanel ( General Health )</ResourceTitle></ListContainer>
                <ListContainer><ResourceTitle to={{pathname:"https://hubermanlab.com/neural-network/"}}> Dr. Andrew Huberman's Newsletter ( General Health )</ResourceTitle></ListContainer>
                <ListContainer><ResourceTitle to={{pathname:"https://www.youtube.com/@PeterAttiaMD"}}>MD Petter Attia's Youtube Chanel ( Cardiovascular Health + Training )</ResourceTitle></ListContainer>
                <ListContainer><ResourceTitle to={{pathname:"https://www.youtube.com/@FoundMyFitness"}}>Dr. Rhonda Patricks's Youtube Chanel ( Nutrition )</ResourceTitle></ListContainer>
                <ListContainer><ResourceTitle to={{pathname:"https://www.youtube.com/@biolayne1"}}>Dr. Layne Norton's Youtube Chanel ( Training + Nutriton )</ResourceTitle></ListContainer>
                <ListContainer><ResourceTitle to={{pathname:"https://www.youtube.com/@drandygalpin"}}>Dr. Andy Galpin's Youtube Chanel ( Best Training Resource )</ResourceTitle></ListContainer>
            </ul>
          </div>
